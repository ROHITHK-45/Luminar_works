...
for(let country of countries){
  ...
  let cntrydata={countryName,countrypopulation,currencyname,countrycapital}
...
mycountries.filter(data=>data.countrypopulation>20000000).map(cntry=>cntry.countryName).forEach(name=>console.log(name))
